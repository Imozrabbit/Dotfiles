    ...
    Item {
        ...
        Loader {
            ...
            sourceComponent: ScreencopyView {
                ...
                Rectangle {
                    ...
                    border.color: {
                        var isSpecial = hWin.lastIpcObject && hWin.lastIpcObject.workspace && hWin.lastIpcObject.workspace.id < 0;
                        if (isSpecial)
                            return thumbContainer.hovered ? "#c9f300d7" : "#4ff300d7";

                        return thumbContainer.hovered ? "#ff0088cc" : "#cc444444";
                    }
                    radius: 16
                }
            }
        ...
        Rectangle {
            ...
            Text {
                ...
                //text: hWin.title
                text: (hWin.lastIpcObject && hWin.lastIpcObject.workspace && hWin.lastIpcObject.workspace.id >= 0 ? "[" + hWin.lastIpcObject.workspace.id + "] " : "") + hWin.title
                color: "#e1e1e2"
