...
end, { desc = "Toggle Buildin Undotree" })

-- Select menu
keymap.set("n", "<leader>m", function()
	require("scripts.select-menu").run()
end, { desc = "Select menu" })
...
vim.api.nvim_create_autocmd("LspAttach", {
	...
	callback = function(event)
		...
		map("glk", vim.lsp.buf.signature_help, "Signature Help")
...
---------------------------------------------------------------------------------------------------------------
-- Select undo
keymap.set("x", "u", ":SelectUndoLine<CR>", { silent = true, desc = "Undo selected lines, one change at a time" })
keymap.set("x", "U", ":SelectUndoSweep<CR>", { silent = true, desc = "Undo every selected line's last change at once" })
keymap.set("x", "p", ":SelectUndoPartial<CR>", { silent = true, desc = "Undo a partial character selection" })
