...
Rectangle {
    ...
    color: root.theme.inputMethodBg
    ...
    Text {
        ...
        color: iconMouse.containsMouse ? root.theme.inputMethodHoverColor : root.knownMethod ? root.theme.inputMethodColor : root.theme.inputMethodUnknownColor
        font {
